    ...
    <div class="w-[250px] h-full text-gray-400">
      ...
      <div class="h-[calc(100vh-50px)] bg-gray-800">
        <div class="flex flex-col justify-between h-full space-y-[10px]">
          ...
          <div class="py-[10px]">
            <router-link to="/Login" class="inline-flex relative items-center py-[10px] px-[20px] w-full text-sm font-medium hover:bg-gray-700 active:bg-gray-900 focus:bg-gray-600 hover:text-white">
              <!-- Icono aquí -->
              Login/Registro
            </router-link>
          </div>
    ...
    showComponent(component) {
      switch (component) {
        case 'home':
          ...
          break;
        case 'usuarios':
          this.currentComponent = 'UsuariosGestor';
          break;
        case 'estaciones':
          this.currentComponent = 'EstacionesGestor';
          break;
        case 'bicicletas':
          this.currentComponent = 'BicicletasGestor';
          break;
        case 'mantenimiento':
          this.currentComponent = 'MantenimientoGestor';
          break;
        case 'alquiler':
          this.currentComponent = 'AlquilerGestor';
          break;
        case 'estadisticas':
          this.currentComponent = 'Estadisticas';
          break;
        case 'viajes':
          this.currentComponent = 'ViajesUs';
          break;
        case 'ubicacion':
          this.currentComponent = 'MapaUbicacion';
          break;
        default:
